...
const Form = ({ type, post, setPost, submitting, handleSubmit }) => {
    ...
    return (
        <section className="w-full max-w-full flex-start flex-col">
            ...
            <p className="desc text-left max-w-md">{type} and share amazing prompts with the world, and let your imagination run with any AI-powered platform</p>
            ...
            <form onSubmit={(e) => handleSubmit(e)} className="mt-10 w-full max-w-2xl flex flex-col gap-7 glassmorphism">
                ...
                <div className="flex-end mx-3 mb-5 gap-4">
                    <button className="text-grey-500 text-sm" onClick={() => router.back()}>Cancel</button>
